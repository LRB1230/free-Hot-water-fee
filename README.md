...
5.长按该数据包，点重写，起一个的名字，右上角下一步，选到请求里面，最下面有一个跟随客户端，点击跟随客户端右边的笔编辑，选择规则替换

6.写规则之前，我们要分析一下这个数据包，关于个人敏感信息我打成功x了
用户身份信息
...
· consumeDate=20251125225153：消费时间（2025年11月xxxxxxxxx)
